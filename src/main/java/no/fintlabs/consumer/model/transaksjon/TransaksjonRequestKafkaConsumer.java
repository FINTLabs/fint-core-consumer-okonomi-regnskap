...
public class TransaksjonRequestKafkaConsumer extends EventRequestKafkaConsumer<TransaksjonResource> {
    public TransaksjonRequestKafkaConsumer(EventConsumerFactoryService eventConsumerFactoryService, TransaksjonConfig transaksjonConfig) {
        super(eventConsumerFactoryService, transaksjonConfig);
    }
}
